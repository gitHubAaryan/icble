<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="icble._Default" %>
...
<div class=" w-100 bg-info">
        ...
        <div class=" container">
            ...
            <div class="row">
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/narendrasinghtomar_0.jpg" alt=""></div>
                        <div class="textBox">
                ...
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/kalash-Choudhary.jpg" alt=""></div>
                        <div class="textBox">
                ...
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/Shobha-Karandlaje.png" alt=""></div>
                        <div class="textBox">
                ...
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/Dr.-Himanshu-Pathak.jpg" alt=""></div>
                        <div class="textBox">
                ...
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/rc_aggawal.jpg" alt=""></div>
                        <div class="textBox">
                ...
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/Dr.-Anuradha-Agarwal.jpg" alt=""></div>
                        <div class="textBox">
                ...
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/Rajender-Parsad.jpg" alt=""></div>
                        <div class="textBox">
                ...
                <div class=" col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="guaidImg">
                        <div class="imgBox">
                            <img src="images/sudeeppic.jpg" alt=""></div>
                        <div class="textBox">
                            <h1>Dr. Sudeep</h1>
                            <p>PI, Component 2 (NAHEP) , <br />(ICAR-IASRI)</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="keyspeakers">
        <div class="col-sm-12 text-center section-title">
            <h2 class="mt-4">UNDER THE GUIDANCE OF</h2>
                ...
                <div class="owl-carousel loop1 owl-theme wow fadeInUp" data-wow-delay="0.6s">
                    <div class="item">
                        <figure>
                            ...
                            <div class="textBox">
                                ...
                                <p>Preferred Topic: Strategies for Blended Teaching-learning</p>
                            </div>
                    ...
                    <div class="item">
                        <figure>
                            ...
                            <div class="imgBox">
                                <img src="images/Bidyut-C-Deka.jpg" />
                            </div>
                            <div class="textBox">
                                <h2>Bidyut C Deka</h2>
                                <p>Upskilling Agri-graduates in Entrepreneurship: Role of Agri incubators</p>
                            </div>
                    ...
                    <div class="item">
                        <figure>
                            ...
                            <div class="textBox">
                                <h2>Sajid Pareeth</h2>
                                <p>
                                    Blended learning in education towards holistic approach in agriculture water management ...
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <figure>
                            <div class="imgBox">
                                <img src="images/SidasSaulynas.jpg" />
                            </div>
                            <div class="textBox">
                                <h2>Sidas Saulynas</h2>
                                <p>
                                    Strategies for Blended Teaching-Learning and specifically relate to the sub-theme...
                                </p>
                            </div>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingFour">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                        href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">What is the theme of the conference and why was it chosen?
                                    </a>
                                </h4>
                            </div>
                ...
                <div class="owl-carousel loop owl-theme wow fadeInUp" data-wow-delay="0.6s">
                    ...
                    <div class="item">
                        <figure>
                            <a href="#">
                                <div class="social-boxes bg-info">
                                   <blockquote class="twitter-tweet"><p lang="en" dir="ltr">A dream of Hon’ble Prime Minister of India, Shri Narendra Modi for digital learning in digital India.<br>Visit <a href="https://t.co/tLnuYLwwnI">https://t.co/tLnuYLwwnI</a> to know more about ICBLE 2023.<a href="https://twitter.com/hashtag/savethedatee?src=hash&amp;ref_src=twsrc%5Etfw">#savethedatee</a> <a href="https://twitter.com/hashtag/ICBLE?src=hash&amp;ref_src=twsrc%5Etfw">#ICBLE</a> <a href="https://twitter.com/hashtag/ICBLE2023?src=hash&amp;ref_src=twsrc%5Etfw">#ICBLE2023</a> <a href="https://twitter.com/hashtag/ICAR?src=hash&amp;ref_src=twsrc%5Etfw">#ICAR</a> <a href="https://twitter.com/hashtag/ICARNEHAP?src=hash&amp;ref_src=twsrc%5Etfw">#ICARNEHAP</a> <a href="https://twitter.com/hashtag/nahep?src=hash&amp;ref_src=twsrc%5Etfw">#nahep</a> <a href="https://twitter.com/hashtag/AzadiKaAmritMahotsav?src=hash&amp;ref_src=twsrc%5Etfw">#AzadiKaAmritMahotsav</a> <a href="https://twitter.com/hashtag/G20Summit2023?src=hash&amp;ref_src=twsrc%5Etfw">#G20Summit2023</a> <a href="https://twitter.com/hashtag/millets2023?src=hash&amp;ref_src=twsrc%5Etfw">#millets2023</a> <a href="https://t.co/VanTWqAuEV">pic.twitter.com/VanTWqAuEV</a></p>&mdash; ICBLE 2023 (@Icble2023) <a href="https://twitter.com/Icble2023/status/1628623685727944705?ref_src=twsrc%5Etfw">February 23, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                                </div>
                            </a>
                        </figure>
                    </div>
