...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Registration-Form.aspx.cs" Inherits="icble.Registration_Form" %>
 ...
 <div class=" container">
        ...
        <div class="row">
           ...
           <%-- <div class="col-md-2 py-2">
            ...
            <div class="col-md-2 py-2">
               <asp:Label ID="modp" runat="server" Text="Mode of participation" class="form-label" style="font-weight: bold; color: #848484; font-family: Montserrat, sans-serif;" Visible="true"></asp:Label>
            ...
            <div class="col-md-10  py-3">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rb_day1_SelectedIndexChanged" CssClass="radio_style"  CellPadding="1" CellSpacing="1">
                            <asp:ListItem Value="1" class="mr-5">&nbsp Online</asp:ListItem>
                            <asp:ListItem Value="0">&nbsp Offline</asp:ListItem>
                        </asp:RadioButtonList>
