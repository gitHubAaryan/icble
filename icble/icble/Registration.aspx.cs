        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (!GetEmailStatus())
            {
                try
                {
                    ...
                    string Query = "Insert into drishti_UserProfile (Candidate_ID,User_Title,Email_ID,Last_name,Middle_name,First_name,Org_name,Designation,Address,Country,Zip_code,State,Gender,City,Mobile_No,Contact_No,Active_Status,modp,Entry_Date,User_type,Professional) values (@Candidate_ID,@User_Title,@Email_ID,@Last_name,@Middle_name,@First_name,@Org_name,@Designation,@Address,@Country,@Zip_code,@State,@Gender,@City,@Mobile_No,@Contact_No,1,@modp,getdate(),@User_type,@Professional)";
