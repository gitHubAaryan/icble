...
$('.moreCatebtn').click(function () {
  $('.moreCatCon').slideToggle('slow'), $(this).hide(), $('.lessCatebtn').show();
});
$('.lessCatebtn').click(function () {
  $('.moreCatCon').slideToggle('slow'), $(this).hide(), $('.moreCatebtn').show();
});
