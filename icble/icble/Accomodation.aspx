<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Accomodation.aspx.cs" Inherits="icble.Accomodation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentinner" runat="server">
     <div class=" aboutbanner"><img src="./images/aboutBanneraco.jpg" alt=""></div>
    <div class=" container">
        <div class="row">
